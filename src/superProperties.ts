...
export class SuperProperties {
    "os": string = SUPER_PROPERTIES._os;
    // _os: string = SUPER_PROPERTIES._os;
    "browser": string = SUPER_PROPERTIES._browser;
    // _browser: string = SUPER_PROPERTIES._browser;
    "device": string = SUPER_PROPERTIES._device;
    // _device: string = SUPER_PROPERTIES._device;
    "system_locale": string = SUPER_PROPERTIES._system_locale;
    // _system_locale: string = SUPER_PROPERTIES._system_locale;
    "browser_user_agent": string = SUPER_PROPERTIES._browser_user_agent; // userAgent will always be refreshed before every request
    // _browser_user_agent: string = SUPER_PROPERTIES._browser_user_agent; // userAgent will always be refreshed before every request
    "browser_version": string = SUPER_PROPERTIES._broswer_version; // browserVersion will always be refreshed before every request
    ...
    "os_version": string = SUPER_PROPERTIES._os_version;
    // _referrer: string = SUPER_PROPERTIES._referrer;
    "referrer": string = SUPER_PROPERTIES._referrer;
    // _referring_domain: string = SUPER_PROPERTIES._referring_domain;
    "referring_domain": string = SUPER_PROPERTIES._referring_domain;
    // _search_engine: string = SUPER_PROPERTIES._search_engine;
    "search_engine": string = SUPER_PROPERTIES._search_engine;
    // _referrer_current: string = SUPER_PROPERTIES._referrer_current;
    "referrer_current": string = SUPER_PROPERTIES._referrer_current;
    // _referring_domain_current: string = SUPER_PROPERTIES._referring_domain_current;
    "referring_domain_current": string = SUPER_PROPERTIES._referring_domain_current;
    // _release_channel: string = SUPER_PROPERTIES._release_channel;
    "release_channel": string = SUPER_PROPERTIES._release_channel;
    // _client_build_number: number = SUPER_PROPERTIES._client_build_number;
    "client_build_number": number = SUPER_PROPERTIES._client_build_number;
    // _client_event_source: any = SUPER_PROPERTIES._client_event_source;
    "client_event_source": any = SUPER_PROPERTIES._client_event_source;
    // _design_id: number = SUPER_PROPERTIES._design_id;
    "design_id": number = SUPER_PROPERTIES._design_id;
